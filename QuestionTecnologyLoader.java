...
public class QuestionTecnologyLoader
{
    private static boolean cicle;
    private static boolean cicleQ;
    ...
    private static void play(Connection conn)
    {
        ...
        try {
            ...
            // Execute the query
            ResultSet rs = stmt.executeQuery("SELECT * from questions where theme_id = 2 ORDER by Rand() limit 7");

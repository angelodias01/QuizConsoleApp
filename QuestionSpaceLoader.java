...
public class QuestionSpaceLoader
{
    ...
    private static void play(Connection conn)
    {
        ...
        try {
            ...
            // Execute the query
            ResultSet rs = stmt.executeQuery("SELECT * from questions where theme_id = 1 ORDER by Rand() limit 7");
    ...
    private static void shuffleArray(String[] arr) {
        ...
        /*
        This code uses the Fisher-Yates shuffle algorithm to shuffle the array in-place. The shuffleArray method takes an array of strings as an input and 
        shuffles it using a random number generator.
         */
